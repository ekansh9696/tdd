...
public class StatementGeneratorTest
{
    ...
    public void noTravel()
    {
        ...
        double fare= v.getFare(Arrays.asList(new Ride(0,0)));
    ...
    {
        StatementGenerator v = new StatementGenerator();
        double fare= v.getFare(Arrays.asList(new Ride(1,5)));
    ...
    {
        StatementGenerator v = new StatementGenerator();
        double fare= v.getFare(Arrays.asList(new Ride(2.5,30)));
    ...
    {
        StatementGenerator v = new StatementGenerator();
        double fare= v.getFare(Arrays.asList(new Ride(2.5,30),new Ride(1,5),new Ride(12,45)));
